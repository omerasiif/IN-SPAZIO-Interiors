    ...
    <div className="site-shell">
      <header className={`site-header ${scrolled ? 'is-scrolled' : ''}`}>
        <button className="brand" onClick={() => scrollTo('top')} aria-label="Back to top">
          <span className="brand-mark">NID</span>
      ...
      <div className={`mobile-nav ${menuOpen ? 'open' : ''}`}>
        ...
        <a href="https://wa.me/918074161073" target="_blank" rel="noreferrer" onClick={() => setMenuOpen(false)}>Start a conversation <ArrowUpRight size={17} /></a>
      </div>
      ...
      <main>
        <section className="hero" id="top">
          ...
          <div className="hero-content reveal-on-load">
            <p className="eyebrow light">Hyderabad · Interior design · Home solutions</p>
            <h1>Interiors designed<br /><em>around the way</em><br />you live.</h1>
            <p className="hero-copy">Thoughtful interior design and home solutions for spaces that feel refined, functional and truly yours.</p>
            <div className="hero-actions">
              <button className="button button-light" onClick={() => scrollTo('projects')}>Explore our work <ArrowDown size={16} /></button>
              <a className="text-link light-link" href="https://wa.me/918074161073" target="_blank" rel="noreferrer">Get a consultation <ArrowUpRight size={16} /></a>
            </div>
          </div>
        ...
        <section className="about section-pad" id="about">
          <div className="section-number">01 <span>About NID</span></div>
          <div className="about-grid">
            ...
            <div className="about-copy">
              <p className="eyebrow">About NID</p>
              <h2>Creating spaces with purpose, character <em>and detail.</em></h2>
              <p className="body-copy">Nid Interior Designing Construction & Home Solution provides interior and home solutions in Hyderabad, helping clients transform their spaces through thoughtful design, practical planning and carefully considered details.</p>
        ...
        <section className="projects section-pad" id="projects">
          ...
          <p className="photo-note">Actual project photography · Nid Interior Designing Construction & Home Solution</p>
        </section>
        ...
        <section className="image-break"><img src={images.partition} alt="Interior detail" loading="lazy" /><div className="image-break-overlay" /><p>Designed for living.</p><span className="break-mark">NID</span></section>
        ...
        <section className="reviews section-pad"><div className="review-grid"><div><p className="eyebrow">07 / Google presence</p><h2>Made to be lived in.<br /><em>Built on trust.</em></h2></div><div className="review-card"><div className="google-g">G</div><div><div className="rating"><strong>4.6</strong><span>★★★★★</span></div><p>Rated 4.6/5 on Google</p><small>29 reviews</small></div><a href="https://www.google.com/maps/search/?api=1&query=Nid+Interior+Designing+Construction+%26+Home+Solution+Hyderabad" target="_blank" rel="noreferrer">View Google reviews <ArrowUpRight size={16} /></a></div></div></section>

        <section className="contact section-pad" id="contact"><div className="contact-map"><div className="map-lines" /><div className="map-pin"><Compass size={19} /></div><div className="map-label">Hyderabad<br /><span>Telangana, India</span></div></div><div className="contact-copy"><p className="eyebrow">08 / Visit us</p><h2>Let's talk about<br /><em>your space.</em></h2><p className="address">Nid Interior Designing Construction & Home Solution<br /><br />1/A, 19-2-197/15,<br />Zoopark, Ramnas Pura,<br />Hyderabad, Telangana 500064,<br />India</p><a className="phone" href="tel:+918074161073">+91 80741 61073</a><div className="contact-actions"><a className="button button-dark" href="tel:+918074161073">Call now <ArrowUpRight size={15} /></a><a className="button button-outline" href="https://wa.me/918074161073" target="_blank" rel="noreferrer">WhatsApp <ArrowUpRight size={15} /></a><a className="directions" href="https://www.google.com/maps/search/?api=1&query=Nid+Interior+Designing+Construction+%26+Home+Solution+Hyderabad" target="_blank" rel="noreferrer">Get directions <ChevronRight size={15} /></a></div></div></section>

        <section className="final-cta"><img src={images.kitchen} alt="Nid Interior Designing kitchen project" loading="lazy" /><div className="final-overlay" /><div className="final-content"><p className="eyebrow light">Nid Interior Designing Construction & Home Solution</p><h2>Let's create a space<br />that <em>feels like yours.</em></h2><p>Have a home or interior project in mind? Start a conversation with us.</p><a className="button button-light" href="https://wa.me/918074161073" target="_blank" rel="noreferrer">Start a conversation <ArrowUpRight size={16} /></a></div></section>
      </main>

      <footer className="footer"><div className="footer-main"><div><span className="footer-logo">NID</span><p>Interior Designing Construction<br />& Home Solution</p></div><div className="footer-links"><span>Explore</span>{navItems.map((item) => <button key={item.id} onClick={() => scrollTo(item.id)}>{item.label}</button>)}</div><div className="footer-links"><span>Connect</span><a href="tel:+918074161073">+91 80741 61073</a><a href="https://wa.me/918074161073" target="_blank" rel="noreferrer">WhatsApp</a><a href="https://www.google.com/maps/search/?api=1&query=Nid+Interior+Designing+Construction+%26+Home+Solution+Hyderabad" target="_blank" rel="noreferrer">Google Maps</a></div></div><div className="footer-bottom"><span>© 2026 Nid Interior Designing Construction & Home Solution</span><span>Hyderabad, Telangana</span></div></footer>
